...
/** Chooses how whichever team is currently out of possession sets up — a high press near the halfway line, or a low block deep near its own goal. */
export function DefensiveStyleToggle({ style, onChange }: Props) {
